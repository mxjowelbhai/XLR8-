...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "hi") || (event.body.toLowerCase() == "hello") || (event.body.toLowerCase() == "hlw") || (event.body.toLowerCase() == "হাই") || (event.body.toLowerCase() == "হ্যালো")) {
  ...
  if ((event.body.toLowerCase() == "humaira") || (event.body.toLowerCase() == "হুমায়রা")) {
   ...
   if ((event.body.toLowerCase() == "you kiss me") || (event.body.toLowerCase() == "kiss me")) {
   ...
   if ((event.body.toLowerCase() == "i love you") || (event.body.toLowerCase() == "Love you") || (event.body.toLowerCase() == "আই লাভ ইউ") || (event.body.toLowerCase() == "আমি তোমাকে ভালোবাসি") || (event.body.toLowerCase() == "i love you")) {
